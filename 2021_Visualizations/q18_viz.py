...
QUESTION_ID = 'Q18'
OPTIONS = ['Yes, I intend to write a senior thesis in the CS department', 'No, I do not intend to write a senior thesis in the CS department', 'I am unsure or undecided']
