...
legend_labels = ['No, I do not intend to write a senior thesis in the CS department', 'I am unsure or undecided', 'Yes, I intend to write a senior thesis in the CS department']
